...
public class PairingActivity extends AppCompatActivity {
    ...
    private void buildKeyboard(){
        ...
        int h=(int)(54*dp);
        String[] rows={"1234567890","ABCDEFGHIJ","KLMNOPQRST","UVWXYZ"};
        for(String row:rows){
            ...
            for(char c:row.toCharArray()){
                Button btn=new Button(this);btn.setText(String.valueOf(c));btn.setTextSize(16f);
                LinearLayout.LayoutParams lp=new LinearLayout.LayoutParams(0,h);lp.weight=1;lp.setMargins(2,2,2,2);
    ...
    private void doPairing(){
        ...
        ex.submit(()->{
            try{
                ...
                rp.sendPairingRequest("androidtvremote","SelcomRemote");
                rp.readPairingMessageType();
                ...
                mh.post(()->{
                    ...
                    if(ok){
                        ...
                        startService(new Intent(this,RemoteService.class).setAction(RemoteService.ACTION_CONNECT).putExtra(RemoteService.EXTRA_HOST,host));
