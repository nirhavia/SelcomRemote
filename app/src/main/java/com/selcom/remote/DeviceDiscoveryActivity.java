...
public class DeviceDiscoveryActivity extends AppCompatActivity {
    ...
    @Override protected void onCreate(Bundle b) {
        ...
        listView.setOnItemClickListener((p, v, pos, id) -> openPairing(hosts.get(pos)));
    ...
    private void openPairing(String host) {
        startActivity(new Intent(this, PairingActivity.class)
            .putExtra(PairingActivity.EXTRA_HOST, host));
    }

    @Override protected void onDestroy() {
        super.onDestroy();
        try { if (discListener != null) nsdManager.stopServiceDiscovery(discListener); }
