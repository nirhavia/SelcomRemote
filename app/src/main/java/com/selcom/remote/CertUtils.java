...
public class CertUtils {
    ...
    public static SSLContext createSSLContext() throws Exception {
        ...
        // KeyManager: presents our client cert during TLS handshake if server requests it
        KeyManagerFactory kmf = KeyManagerFactory.getInstance("X509");
        kmf.init(ks, null);

        // TrustManager: accept any server certificate (TV uses self-signed)
